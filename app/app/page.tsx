        ...
        <header className="relative z-50 flex flex-col md:flex-row justify-between items-center p-6 max-w-6xl mx-auto">
          ...
          >
            ...
            <h1 className="text-3xl font-extrabold tracking-tight">
              Solana <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">Billing</span>
            </h1>
          </motion.div>
          ...
          >
             <WalletMultiButton style={{ backgroundColor: 'rgba(124, 58, 237, 0.8)', backdropFilter: 'blur(10px)' }} />
          </motion.div>
        </header>
